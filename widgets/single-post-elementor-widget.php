...
class PEAW_Single_Post extends WP_Widget{
	...
	public function widget($args, $instance){
		...
		$call_text 	= ($instance['call_text']) ? $instance['call_text'] : 'Insert an Awesome Calling text here.' ; 
		...
		//Create error message to display as a post card
			...
			$post_title = 'Post not Found, insert a valid ID';
			$publish_date = 'date not found';
			$category_output = "<a class='peaw-category-link' href='#'> Category not found </a>";
			$post_link = "#";
		}
	...
	?>
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 'call_text' ) ); ?>"><?php esc_attr_e( 'call text:', 'text_domain' ); ?></label> 
